...
@Size(min=2, max=30, message="First Name must be at least 2 characters long and less than 30 characters ")
String first_name;
String last_name;
...
public  @Size(min = 10, max = 10, message = "Phone number must be of 10 digits") String getPhoneno() {
	return phoneno;
}
public void setPhoneno(@Size(min = 10, max = 10, message = "Phone number must be of 10 digits") String phoneno) {
...
public User_registry(int id, String email_id, @Size(min=2, max=30, message="First Name must be at least 2 characters long and less than 30 characters ") String first_name, String last_name, @Size(min = 10, max = 10, message = "Phone number must be of 10 digits") String phoneno, String address,
